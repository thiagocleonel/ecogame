...
class BadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post badges_url, params: { badge: { given_count: @badge.given_count, name: @badge.name } }
    end
  ...
  test "should update badge" do
    patch badge_url(@badge), params: { badge: { given_count: @badge.given_count, name: @badge.name } }
