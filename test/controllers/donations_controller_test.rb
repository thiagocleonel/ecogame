...
class DonationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post donations_url, params: { donation: { citizen_id: @donation.citizen_id, ecopoint_id: @donation.ecopoint_id, material_id: @donation.material_id, weight: @donation.weight } }
    end
  ...
  test "should update donation" do
    patch donation_url(@donation), params: { donation: { citizen_id: @donation.citizen_id, ecopoint_id: @donation.ecopoint_id, material_id: @donation.material_id, weight: @donation.weight } }
